...
export const makeGroupsSocket = (config: SocketConfig) => {
	...
	return {
		 ...
		 */
		groupAcceptInviteV4: ev.createBufferedFunction(async(key: string | WAMessageKey, inviteMessage: WAE2E.Message.IGroupInviteMessage) => {
			...
			if(key.id) {
				...
				inviteMessage = WAE2E.Message.GroupInviteMessage.fromObject(inviteMessage)
