...
import { encodeRawMessage, isJidGroup, isJidNewsletter, isJidStatusBroadcast, jidNormalizedUser } from '../WABinary'
...
export const prepareWAMessageMedia = async(
    ...
    if(cacheableKey) {
        ...
        options.mediaCache!.set(cacheableKey, encodeRawMessage(obj))
    }
...
export const generateForwardMessageContent = (
	...
	content = proto.Message.decode(encodeRawMessage(content!))
...
export const generateWAMessageFromContent = (
	...
	// if quoted, then add context info, but only if it's not a newsletter
