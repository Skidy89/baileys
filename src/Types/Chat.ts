import type { WAHistorySync, WAServerSync, WAWebProtobufSyncAction } from '../../WAProto'
...
export type ChatMutation = {
    syncAction: WAWebProtobufSyncAction.ISyncActionData
    index: string[]
}

export type WAPatchCreate = {
    syncAction: WAWebProtobufSyncAction.ISyncActionValue
    index: string[]
    type: WAPatchName
    apiVersion: number
    operation: WAServerSync.SyncdMutation.SyncdOperation
}

export type Chat = WAHistorySync.IConversation & {
 ...
 * */
export type LastMessageList = MinimalMessage[] | WAWebProtobufSyncAction.SyncActionValue.ISyncActionMessageRange
