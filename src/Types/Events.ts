...
import { WAE2E, WAHistorySync, WAWeb } from '../../WAProto'
...
export type BaileysEventMap = {
    ...
    'messaging-history.set': {
        ...
        syncType?: WAHistorySync.HistorySync.HistorySyncType
    ...
    'messages.reaction': { key: WAMessageKey, reaction: WAWeb.IReaction }[]
...
export type BufferedEventData = {
    ...
    messageReactions: { [key: string]: { key: WAMessageKey, reactions: WAWeb.IReaction[] } }
    messageReceipts: { [key: string]: { key: WAMessageKey, userReceipt: WAWeb.IUserReceipt[] } }
